      ...
      <div className="bg-slate-900/60 border-b border-slate-800 px-4 lg:px-8">
        <div className="max-w-7xl mx-auto flex items-center gap-2 overflow-x-auto py-2.5 scrollbar-none text-xs">
          {[
            ...
            { id: 'github', label: '4. GitHub CI/CD & OTA обновлений', icon: GitPullRequest },
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 md:p-6 lg:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex items-center gap-3">
            ...
            <div>
              <div className="text-[11px] text-slate-400">GitHub Actions CI/CD:</div>
              <div className="text-xs font-semibold text-slate-100">Авто-сборка firmware.bin</div>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex items-center gap-3">
            ...
            <div>
              <div className="text-[11px] text-slate-400">OTA Обновления:</div>
              <div className="text-xs font-semibold text-slate-100">Каждые {config.otaCheckIntervalMinutes} мин по Wi-Fi</div>
            </div>
          </div>
        </div>
